<script lang="ts">
    ...
    import { PEOPLE_POSITIONS } from '../../../assets/land_use/people_positions';
    import landUseUrl from '../../../assets/land_use/land_use.csv?url';
    import { LandUseLabels, type LandUsePlot } from '../../../assets/land_use/land_use.model';
    onMount(() => {
...
<g transform="matrix(0.788788,0,0,0.788788,577.797,260.419)" class="people">
    <g transform="matrix(1.27825,0,0,1.27825,-789.54,-693.315)">
        ...
        <rect x="171.197" y="923.712" width="330" height="330" style="fill:none;stroke:black;stroke-width:0.99px;" />
    </g>
        ...
        <g class="person" id="p{index}" transform="matrix(1,0,0,1,{person[0]},{person[1]})" style="animation-delay:$">
            <g transform="matrix(1,0,0,1,-700,-102)">
                <path
                    ...
                    style="fill:var(--color);stroke:black;stroke-width:1.27px;"
                />
            </g>
            <g transform="matrix(1,0,0,1,-701.464,-91.0269)">
                <circle cx="746.833" cy="882.924" r="12.431" style="fill:white;stroke:black;stroke-width:1.27px;" />
            </g>
